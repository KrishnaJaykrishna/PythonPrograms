...
df = pd.read_csv("interventions_data/School2.csv")
...
df = pd.read_csv("interventions_data/School_1_sample.csv")
data = df["Math_score"].tolist()
...
df = pd.read_csv("interventions_data/School_2_Sample.csv")
data = df["Math_score"].tolist()
...
df = pd.read_csv("interventions_data/School_3_Sample.csv")
data = df["Math_score"].tolist()
